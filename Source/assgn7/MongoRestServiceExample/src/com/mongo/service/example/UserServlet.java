...
public class UserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		MongoClientURI uri = new MongoClientURI("mongodb://tejuuganne:GO4it123@@ds019628.mlab.com:19628/teju");
		MongoClient client = new MongoClient(uri);

		DB db = client.getDB(uri.getDatabase());
		DBCollection users = db.getCollection("sample");
		BasicDBObject query = new BasicDBObject();
		query.put("name","tejuuganne");// request.getParameter("name"));
		query.put("password","GO4it123@"); //request.getParameter("password"));
